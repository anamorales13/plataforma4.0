            ...
            <div className="menu-perfil menu-mensaje">
                ...
                <nav> <ul>
                    <li>
                        ...
                        <NavLink exact to="/destinos" activeClassName="active"> <span className="glyphicon glyphicon-send"></span>Nuevo destino</NavLink >
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <NavLink exact to="/borrar-destinos" > <span className="glyphicon glyphicon-save"></span> Eliminar destinos </NavLink >
                    </li>
